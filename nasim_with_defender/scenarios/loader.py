...
from nasim_with_defender.scenarios import Scenario
from nasim_with_defender.scenarios.host import Host


# dictionary of valid key names and value types for config file
VALID_CONFIG_KEYS = {
    # defender defined
    u.DEFENDER_CHANGE: list,
    u.DEFENDER_STOP: list,
    u.SUBNETS: list,
    u.TOPOLOGY: list,
...
# Defender keys
CHANGE_OS_KEYS = {
    u.CHANGE_OS_COST: (int, float),
    u.CHANGE_OS_PROB: (int, float),
    u.CHANGE_OS_ACCESS: (str, int)
}

CHANGE_FIREWALL_KEYS = {
    u.CHANGE_FIREWALL_COST: (int, float),
    u.CHANGE_FIREWALL_PROB: (int, float),
    u.CHANGE_FIREWALL_ACCESS: (str, int)
}

STOP_PROC_KEYS = {
    u.STOP_PROC_COST: (int, float),
    u.STOP_PROC_PROB: (int, float),
    u.STOP_PROC_ACCESS: (str, int)
}

STOP_SERVICE_KEYS = {
    u.STOP_SERVICE_COST: (int, float),
    u.STOP_SERVICE_PROB: (int, float),
    u.STOP_SERVICE_ACCESS: (str, int)
}
